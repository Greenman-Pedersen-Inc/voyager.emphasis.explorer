define(function() {
    ...
    return {
        ...
        countyJurisdictionsURL: generalURL + 'mvt/county_boundaries_of_nj/{z}/{x}/{y}?geom_column=wkb_geometry&columns=mun_cty_co',
        municipalJurisdictionsURL: generalURL + 'mvt/municipal_boundaries_of_nj/{z}/{x}/{y}?geom_column=wkb_geometry&columns=mun_mu%2C+county%2C+mun_cty_co',
