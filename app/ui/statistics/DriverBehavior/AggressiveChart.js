define(
    ...
    function(
        ...
        const dataAttribute = 'AggressiveAverageData';
        const chart = document.getElementById('AggressiveRollingAverageChart');
        const chartContainer = document.getElementById('AggressiveRollingAverageChartContainer');
        const chartLoading = document.getElementById('AggressiveRollingAverageChartLoading');
        const chartTitle = document.getElementById('AggressiveRollingAverageChartTitle');

        return function AggressiveRollingAverageChart() {
            const self = this;
            ...
            this.updateChartTitle = function() {
                chartTitle.innerHTML = "5 Year Rolling Average - Aggressive";
            }
