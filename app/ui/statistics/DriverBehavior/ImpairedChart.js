define(
    ...
    function(
        ...
        const dataAttribute = 'ImpairedAverageData';
        const chart = document.getElementById('ImpairedRollingAverageChart');
        const chartContainer = document.getElementById('ImpairedRollingAverageChartContainer');
        const chartLoading = document.getElementById('ImpairedRollingAverageChartLoading');
        const chartTitle = document.getElementById('ImpairedRollingAverageChartTitle');

        return function ImpairedRollingAverageChart() {
            const self = this;
            ...
            this.updateChartTitle = function() {
                chartTitle.innerHTML = "5 Year Rolling Average - Impaired";
            }
