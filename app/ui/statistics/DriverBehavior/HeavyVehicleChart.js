define(
    ...
    function(
        ...
        const dataAttribute = 'HeavyVehicleAverageData';
        const chart = document.getElementById('HeavyVehicleRollingAverageChart');
        const chartContainer = document.getElementById('HeavyVehicleRollingAverageChartContainer');
        const chartLoading = document.getElementById('HeavyVehicleRollingAverageChartLoading');
        const chartTitle = document.getElementById('HeavyVehicleRollingAverageChartTitle');

        return function HeavyVehicleRollingAverageChart() {
            const self = this;
            ...
            this.updateChartTitle = function() {
                chartTitle.innerHTML = "5 Year Rolling Average - Heavy Vehicle";
            }
