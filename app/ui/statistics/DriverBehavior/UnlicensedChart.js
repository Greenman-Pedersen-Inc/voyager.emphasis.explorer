define(
    ...
    function(
        ...
        const dataAttribute = 'UnlicensedAverageData';
        const chart = document.getElementById('UnlicensedRollingAverageChart');
        const chartContainer = document.getElementById('UnlicensedRollingAverageChartContainer');
        const chartLoading = document.getElementById('UnlicensedRollingAverageChartLoading');
        const chartTitle = document.getElementById('UnlicensedRollingAverageChartTitle');

        return function UnlicensedRollingAverageChart() {
            const self = this;
            ...
            this.updateChartTitle = function() {
                chartTitle.innerHTML = "5 Year Rolling Average - Unlicensed";
            }
