define(
    ...
    function(
        ...
        const dataAttribute = 'UnbeltedAverageData';
        const chart = document.getElementById('UnbeltedRollingAverageChart');
        const chartContainer = document.getElementById('UnbeltedRollingAverageChartContainer');
        const chartLoading = document.getElementById('UnbeltedRollingAverageChartLoading');
        const chartTitle = document.getElementById('UnbeltedRollingAverageChartTitle');

        return function UnbeltedRollingAverageChart() {
            const self = this;
            ...
            this.updateChartTitle = function() {
                chartTitle.innerHTML = "5 Year Rolling Average - Unbelted";
            }
