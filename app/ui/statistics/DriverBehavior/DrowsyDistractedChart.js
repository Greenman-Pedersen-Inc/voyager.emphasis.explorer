define(
    ...
    function(
        ...
        const dataAttribute = 'DrowsyDistractedAverageData';
        const chart = document.getElementById('DrowsyDistractedRollingAverageChart');
        const chartContainer = document.getElementById('DrowsyDistractedRollingAverageChartContainer');
        const chartLoading = document.getElementById('DrowsyDistractedRollingAverageChartLoading');
        const chartTitle = document.getElementById('DrowsyDistractedRollingAverageChartTitle');

        return function DrowsyDistractedRollingAverageChart() {
            const self = this;
            this.requestUrl = urls.emphasisArea_RollingAverageStatistics;
            // this.update = function (responseData) {
            //     var chartData = responseData.data.EmphasisAreaData['DriverBehaviorAverageData'][dataAttribute];
            ...
            this.updateChartTitle = function() {
                chartTitle.innerHTML = "5 Year Rolling Average - Drowsy/Distracted";
            }
            this.update = function(filterParameters) {
                ...
                return esriRequest(self.requestUrl, { query: requestParams }).then(function(response) {
                    var chartData = response.data.EmphasisAreaData['DriverBehaviorAverageData'][dataAttribute];
