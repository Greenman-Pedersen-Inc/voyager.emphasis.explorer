define(
    ...
    function(
        ...
        const dataAttribute = 'MotorcyclistAverageData';
        const chart = document.getElementById('MotorcyclistRollingAverageChart');
        const chartContainer = document.getElementById('MotorcyclistRollingAverageChartContainer');
        const chartLoading = document.getElementById('MotorcyclistRollingAverageChartLoading');
        const chartTitle = document.getElementById('MotorcyclistRollingAverageChartTitle');

        return function MotorcyclistRollingAverageChart() {
            const self = this;
            ...
            this.updateChartTitle = function() {
                chartTitle.innerHTML = "5 Year Rolling Average - Motorcyclists";
            }
