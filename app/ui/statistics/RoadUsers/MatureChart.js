define(
    ...
    function(
        ...
        const dataAttribute = 'MatureAverageData';
        const chart = document.getElementById('MatureRollingAverageChart');
        const chartContainer = document.getElementById('MatureRollingAverageChartContainer');
        const chartLoading = document.getElementById('MatureRollingAverageChartLoading');
        const chartTitle = document.getElementById('MatureRollingAverageChartTitle');

        return function MatureRollingAverageChart() {
            const self = this;
            ...
            this.updateChartTitle = function() {
                chartTitle.innerHTML = "5 Year Rolling Average - Mature Drivers";
            }
        ...
        function formatData(data) {
            ...
            var fileName = 'Road_Users_Mature_Chart_' + categoryLabel;
