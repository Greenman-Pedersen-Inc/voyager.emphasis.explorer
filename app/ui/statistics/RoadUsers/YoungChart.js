define(
    ...
    function(
        ...
        const dataAttribute = 'YoungerAverageData';
        const chart = document.getElementById('YoungRollingAverageChart');
        const chartContainer = document.getElementById('YoungRollingAverageChartContainer');
        const chartLoading = document.getElementById('YoungRollingAverageChartLoading');
        const chartTitle = document.getElementById('YoungRollingAverageChartTitle');

        return function YoungRollingAverageChart() {
            const self = this;
            ...
            this.updateChartTitle = function() {
                chartTitle.innerHTML = "5 Year Rolling Average - Younger Drivers";
            }
