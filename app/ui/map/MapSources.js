define([
    ...
    return function MapSources(map, credentials) {
        ...
        const layerDefinitions = {
            county_heatmap: {
                ...
                legend: {
                    ...
                    colorFill: ['interpolate', ['linear'], ['get', 'crashes']],
            ...
            ard_accidents: {
                ...
                layers: [
                    ...
                    },
                    {
                        ...
                        click: function (feature) {
                            return getFeatureDetails([feature.properties.crashid], map.filterParameters).then(
                                (detailedFeatureArray) => {
                                    return {
                                        content: new CrashDetails(map, detailedFeatureArray).domNode,
                                    };
                                }
            ...
            sri: {
                ...
                legend: {
                    ...
                    colorArray: ['#a1dbb2', '#fee5ad', '#faca66', '#f7a541', '#f45d4c'],
                    'circle-color': ['interpolate', ['linear'], ['get', 'crashes']],
                    countAttribute: 'crashes',
                ...
                layers: [
                    {
                        ...
                        click: function (feature) {
                            return {
                                ...
                                description:
                                    'Current Population Survey Annual Social and Economic Supplements (CPS ASEC) conducted by the U.S. Census Bureau.',
            ...
            county: {
                ...
                click: function (feature) {
                    return {
                        title: 'County Info',
                        description:
                            'Municipal information taken from <a href="https://gisdata-njdep.opendata.arcgis.com/">NJDEP Open Data.</a>',
                        table: feature.properties,
                    };
                },
            },
            municipality: {
                ...
                click: function (feature) {
                    return {
                        ...
                        description:
                            'County information taken from <a href="https://gisdata-njdep.opendata.arcgis.com/">NJDEP Open Data.</a>',
                        table: feature.properties,
                    };
                },
            },
        ...
        this.getMapLayerData = function (layerName) {
            ...
            eachRecursive(
                Object.values(
                    Object.assign(overlayLayers, layerDefinitions, self.jurisdictionLayerDefinitions)
                ),
                layerName
            );
