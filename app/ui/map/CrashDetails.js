define([
    ...
    function PoliceFormButton(feature, filterParameters, credentials) {
        ...
        if (feature.hasOwnProperty('dln')) {
            ...
            if (feature.hasOwnProperty('dln')) {
                requestParams['dlnNum'] = self.feature.dln;
            }

            const reportUrlParams = Object.keys(requestParams)
    ...
    return function CrashDetails(map, features, credentials) {
        ...
        leftButton.onclick = function (event) {
            ...
            if (features[self.index].hasOwnProperty('dln')) {
                requestParams['dlnNum'] = self.features[self.index].dln;
            }
            ...
            googleMapsButton.button.href = `https://maps.google.com/maps?q=&layer=c&cbll=${
                self.features[self.index].calc_latitude
            },${self.features[self.index].calc_longitude}&cbp=12,&{dirDegrees},0,0,0`;
        ...
        indexLabelDiv.style =
            'display: inline-block; padding: 0 0.25em; font-size: 0.875 rem; line-height: 1.5; font-weight: bold;';
