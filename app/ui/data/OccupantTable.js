define([
    ...
    return function OccupantTable(map, credentials) {
        const self = this;
        ...
        this.updateChartTitle = function (filterParameters) {
            if (filterParameters.subCategory.label) {
                chartTitle.innerHTML =
                    'Occupants Persons Data - ' +
                    filterParameters.category.label +
                    ' (' +
                    filterParameters.subCategory.label +
                    ')';
            } else chartTitle.innerHTML = 'Occupants Persons Data - ' + filterParameters.category.label;
        };
